...
exports.signup = async (req, res) => {
  try {
    ...
    await sendEmail(
      email,
      "Verify your Syca_Ecommerce account",
      otpEmail,
      true
    );
...
exports.completeSignup = async (req, res) => {
  try {
    ...
    const welcomeEmail = `
      <div style="font-family: Arial, sans-serif; padding: 20px; background: #f1f1f1;">
        ...
        <p style="font-size:15px; color:#444;">
          You’re now part of our growing community. Start exploring products, 
          track your orders, and enjoy exclusive offers made just for you.
        </p>
    ...
    return res
      .status(500)
      .json({ error: "Signup completion failed. Please try again." });
  }
};
